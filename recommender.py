...
# Test point with movie data < Change the movie with macro provided in test_movies.py >
...
# Print list of 5 recommendations < Change value of k for a different number >
